...
exports.XXH32 = void 0;
const types_js_1 = require("./types.cjs");
const PRIME32_1 = new types_js_1.Uint32("2654435761");
const PRIME32_2 = new types_js_1.Uint32("2246822519");
const PRIME32_3 = new types_js_1.Uint32("3266489917");
const PRIME32_4 = new types_js_1.Uint32("668265263");
const PRIME32_5 = new types_js_1.Uint32("374761393");
function xxh_update(v, low, high) {
    const other = new types_js_1.Uint32().fromBits(low, high);
    return v.add(other.multiply(PRIME32_2)).rotl(13).multiply(PRIME32_1);
}
const nullBuffer = new Uint8Array(16);
class XXH32 {
    seed;
    v1 = new types_js_1.Uint32();
    v2 = new types_js_1.Uint32();
    v3 = new types_js_1.Uint32();
    v4 = new types_js_1.Uint32();
    total_len = 0;
    memsize = 0;
    memory = new Uint8Array(16);
    constructor(seed) {
        this.seed = types_js_1.Uint32.from(seed || 0);
        this.#reset();
    }
    #reset() {
