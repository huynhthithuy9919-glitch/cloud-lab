import { TimeFactory, IsLogger, Level, LevelHandlerImpl, LogCollector, LoggerImpl, logValue, Result, runtimeFn, TimeMode, BuildURI, URI, JSONFormatter, YAMLFormatter, BasicSysAbstractionFactory, TxtEnDecoderSingleton, ReadonlyURL, ConsoleWriterStream, stripper, } from "@adviser/cement";
...
describe("TestLogger", () => {
    ...
    function splitDateGetTime(date) {
        if (!date) {
            return 0;
        }
